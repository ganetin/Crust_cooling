...
cc      rhol=.1324
ccc This correspond to a density of 2.2e14 g/cm3 for the core limit
cc      rhod=2.573e-4
ccc This correspond to a density of 4.3e11 g/cm3 for neutron drip
...
5     gread_value=gread(5,6,.true.,.true.)
...
c *************************************************************************
      ...
      common/interp/ i1,i2,i3,limit
c      write(6,*) c2
c      title='/Users/dany/Work/NStar/EOS/'//title
      title='/home/forgane/Desktop/NSCool/EOS/Quark/'
     1           //title
      write(*,*)    title
...
c       write(*,10010) i,eeos(i)/const,peos(i)/const*c2,deos(i)
      end do
...
10000 format(i6,0pf18.9,1p1e18.9,1e18.9,1e18.9,1e18.9,1e18.9,1e18.9)
10001 format(4i8)
