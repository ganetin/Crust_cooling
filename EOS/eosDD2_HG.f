...
CCC Ep=938.272046,En=939.565379
      IMPLICIT NONE
 3334 FORMAT (1X,17E16.8)
      real*8 dattab(15)
      real*8 nb(500),P(500),rho(500),ne(500),np(500),nn(500)
      real*8 Ye(500),Ym(500),Yp(500),Yn(500)
      ...
      K=0
      OPEN (3,file='DD2_HG.dat',status='old')
c*** 7 lines of comments in input file
      DO 90 I=1,1
 90      READ (3,*)
 7    K=K+1
 71   READ (3,*,END=8,ERR=71) (dattab(i),i=1,15)
      P(K)=dattab(2)*1.6022e33
      rho(K)=dattab(3)*1.7827e12
      nb(K)=dattab(4)
      nn(K)=dattab(5)
      np(K)=dattab(6)
      ne(K)=dattab(9)
...
!      ENDDO
      ...
      DO K=KDAT,1,-1
         write(90,3334)RHO(K),P(K),nb(K),Ye(K),Ym(K),Yn(K),Yp(K),ZERO
     1   ,ZERO,ZERO,ZERO,SEVEN,SEVEN,ZERO,ZERO,ZERO,ZERO            
      ENDDO 
!c Input
!      integer KEOS
!      real*8 nb
