...
c April 2004: seperate Tc for flavor AND color:
     ...
     3          tcs1(0:isize),tcs2(0:isize),tcs3(0:isize)
      ...
      dimension hfb_a0(0:isize),hfb_a1(0:isize),hfb_a2(0:isize),
     1          hfb_a3(0:isize),hfb_d0(0:isize)
     ...
     6	                kfmax_n3p2,delkf_n3p2,tcmax_n3p2,rcvcr,isf
...
c**** Interpolation of Cvs in the crust
       common/hfb/hfb_a0,hfb_a1,hfb_a2,hfb_a3,hfb_d0
